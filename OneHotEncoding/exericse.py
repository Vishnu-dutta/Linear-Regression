...
'''
Although we talked about dummy variable trap yet we don't see as such in this case. We are getting the same values as
output
...
print(reg.predict([[45000,4,0,0,1]]))               Mercedes benz that is 4 yr old with mileage 45000
print(reg.predict([[86000,7,0,1,0]]))               BMW X5 that is 7 yr old with mileage 86000
'''
...
print(final)
print(reg.predict([[45000,4,0,1]]))                                 # Mercedes benz that is 4 yr old with mileage 45000
